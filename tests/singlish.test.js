...
const testCases = [
  ...
  { id: 'Pos_Fun_0004', input: 'karuNaakaralaa mata me pota laba dhenavadha?', expected: 'කරුණාකරලා මට මේ පොත ලබා දෙනවද?' },
  { id: 'Pos_Fun_0005', input: 'mata baya naee', expected: 'මට බය නැ' },
  { id: 'Pos_Fun_0006', input: 'mama iyee kolamba giyaa', expected: 'මම ඊයේ කොළඹ ගියා' },
  ...
  { id: 'Pos_Fun_0009', input: 'ela machang, kohomada?', expected: 'එල මචන්, කොහොමද?' },
  { id: 'Pos_Fun_0010', input: 'man gedhara yanavaa,adhyapanayata amathaka vuna vidyala lamayin visin deka deranayak ghatanayak sidu kara gatha. police vishvasa karanne meya sathunakama karana ghatanayak kiyala', expectedContains: 'අධ්‍යාපනයට' },
  { id: 'Pos_Fun_0011', input: 'mata rupees 5000 oonay, 3.30 PM vadiyata', expectedContains: '5000' },
  ...
  { id: 'Pos_Fun_0016', input: 'eka aragen innako!', expected: 'එක අරගෙන් ඉන්නකො!' },
  { id: 'Pos_Fun_0017', input: 'oyaata cm 100 yavanna puluvandha?', expectedContains: '100' },
  { id: 'Pos_Fun_0018', input: 'mama gedhara yanavaa\noya enavadha?', expectedContains: 'ගෙදර' },
  { id: 'Pos_Fun_0019', input: 'api kreeda karamu', expectedContains: 'අපි' },
  { id: 'Pos_Fun_0020', input: 'karuNaakaralaa mata help ekak karanna, machang!', expectedContains: 'help' },
  { id: 'Pos_Fun_0021', input: 'baya naee baya naee', expectedContains: 'බය' },
  { id: 'Pos_Fun_0022', input: 'mata WhatsApp call ekak karanna, zoom hariyata naee', expectedContains: 'WhatsApp' },
  { id: 'Pos_Fun_0023', input: 'mama ehema karanna epaa', expected: 'මම එහෙම කරන්න එපා' },
  { id: 'Pos_Fun_0024', input: 'oyaa 7.30 AM bus ekata yanavadha?', expectedContains: '7.30' },
